...
CREATE TABLE `metric` (
  ...
  `decoding_time` float DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `result_detail` (
  ...
  `mp_circuits` int(11) DEFAULT NULL,
  `prune_type` varchar(45) DEFAULT NULL,
  `prune_parameters` varchar(45) DEFAULT NULL,
...
-- Dump completed on 2025-03-24 17:46:22

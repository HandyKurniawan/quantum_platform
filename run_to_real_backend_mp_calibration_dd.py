...
def run_simulation_all(hw_name:str, 
    ...
    run_simulation_one(hw_name, noise_levels, file_path=file_path, 
                       ...
                       mp_options=mp_options, seq_type=seq_type)
    ...
    run_simulation_one(hw_name, noise_levels, file_path=file_path, 
                       compilations=["qiskit_3"], triq_measurement_type="polar_meas", 
                       repeat=reps, shots=shots,
                       mp_options=mp_options, prune_options=prune_options, seq_type=seq_type
                        )
...
for i in range(1):
    ...
    if not conf.use_ibm_cloud:
        try:
            run_simulation_all("ibm_kyiv", 4000, seq_type="XpXm")
            run_simulation_all("ibm_kyiv", 4000, seq_type="XY4")
            pass
        ...
        try:
            run_simulation_all("ibm_sherbrooke", 4000, seq_type="XpXm")
            run_simulation_all("ibm_sherbrooke", 4000, seq_type="XY4")
            pass
        ...
        try:
            run_simulation_all("ibm_brisbane", 4000, seq_type="XpXm")
            run_simulation_all("ibm_brisbane", 4000, seq_type="XY4")
            pass
    ...
    if conf.use_ibm_cloud:
        try:
            run_simulation_all("ibm_fez", 4000, (0.025, 0.05), (0.01, 0.05), seq_type="XpXm")
            run_simulation_all("ibm_fez", 4000, (0.025, 0.05), (0.01, 0.05), seq_type="XY4")
            pass
        ...
        try:
            run_simulation_all("ibm_torino", 4000, (0.025, 0.05), (0.01, 0.05), seq_type="XpXm")
            run_simulation_all("ibm_torino", 4000, (0.025, 0.05), (0.01, 0.05), seq_type="XY4")
            pass
        ...
        try:
            run_simulation_all("ibm_marrakesh", 4000, (0.025, 0.05), (0.01, 0.05), seq_type="XpXm")
            run_simulation_all("ibm_marrakesh", 4000, (0.025, 0.05), (0.01, 0.05), seq_type="XY4")
